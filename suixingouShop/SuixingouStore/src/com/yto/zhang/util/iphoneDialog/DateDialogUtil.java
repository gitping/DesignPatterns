...
public class DateDialogUtil {
	 ...
	 * @param callBack
	 */
	public void getDateDialog(Context con, int type, String dateFromat, DateDialogCallBack callBack) {
		DateDialogUtil.ddcb = callBack;
		dialogUtil = IphoneDialogUtil.getInstance(con);
		dialogUtil.getDatePickDialog(type, dateFromat, new DialogClickListener()).show();
	}
