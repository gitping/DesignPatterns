...
public class FGuideActivity extends FBaseActivity {
	...
	public class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			...
			case 0:
				...
				mPage3.setImageDrawable(getResources().getDrawable(R.drawable.fpage));
				break;
			case 1:
			...
			case 3:
				...
				mPage1.setImageDrawable(getResources().getDrawable(R.drawable.fpage));
				mPage2.setImageDrawable(getResources().getDrawable(R.drawable.fpage));
				mPage3.setImageDrawable(getResources().getDrawable(R.drawable.fpagenow));
				break;
			default:
				break;
			}
	...
	public void startbutton(View v) {
		...
		intent.setClass(FGuideActivity.this, ExpressLoginChooseActivity.class);
	...
	protected void setupView() {
		...
		View view4 = mli.inflate(R.layout.fguidead, null);
