...
public class StoreMyExpressActivityHelper {
	...
	public StoreMyExpressActivityHelper(Context context) {
		super();
		this.context = context;
	}
	public void getData(ShopExpressOrderReqJo seoq,final FRequestCallBack fRequestCallBack){
		FrameRequest fr=FMakeRequest.getStoreMyExpressOrders(seoq);
		...
		http.post(fr.getUrl(), fr.getAp(), new AjaxCallBack<String>() {
			...
			public void onSuccess(String t) {
				...
				super.onSuccess(t);
				Trace.i("StoreMyExpressActivityHelper,onSuccess:"+t);
				parseParameter(t, ShopExpressOrderResJo.class, fRequestCallBack);
				...
				if(rdo.getCode()==FConstants.SUCCESS){
					...
					Trace.i("StoreMyExpressActivityHelper,onSuccess:"+num);
					HashMap<String, Integer> hashMap=JSON.parseObject(num, HashMap.class);
					if (rdo.getCode() == FConstants.SUCCESS) {
...
//				}
			...
			public void onFailure(Throwable t, int errorNo, String strMsg) {
				...
				Trace.i("StoreMyExpressActivityHelper,onFailure:"+t);
