...
public class XListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		mContainer = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.view_xlistview_header, null);
		...
		progressbarrl = (RelativeLayout) findViewById(R.id.xlistview_header_progressbarrl);
